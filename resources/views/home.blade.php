        ...
        <div class="col-md-8">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('inventori.show', $inventory)}}" button type="button" class="btn btn-danger">Show</button></a>
                                </td>
                            @endforeach
                            </tr>
                        </tbody>
            ...
            <div class="card mt-2">
                <div class="card-header">Inventory Type {{ Auth::user()->name }}</div>
                    ...
                    <a href="{{route('type.index')}}" button type="button" class="btn btn-primary">Tambah baru</button></a>
